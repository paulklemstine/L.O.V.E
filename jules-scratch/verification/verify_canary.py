...
def run_canary_test(playwright):
    ...
    try:
        ...
        print("Waiting for 10 seconds to capture initial console logs...")
        time.sleep(10)
        ...
        if canary_found:
            ...
            raise Exception("FAILURE: Canary message NOT found. JavaScript is not executing or logs are not being captured.")
