...
# --- IPFS Helper ---
def _get_ipfs_client(console: Console = None):
...
def _pin_to_ipfs(client, data_bytes: bytes, console: Console = None):
...
def _verify_pin_on_gateways(cid: str, console: Console = None):
...
def save_all_state(love_state: dict, console: Console = None):
    ...
    try:
        ...
        if interesting_files and console:
